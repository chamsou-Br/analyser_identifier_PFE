...
function Status(props: Props) {
  ...
  return (
    <div className="status">
      <div
      onClick={()=>console.log(props.status.replace("-","_"))}
        className="status-container"
        style={
          styles[props.status.replace("-","_").toLowerCase() as keyof statusStyle] != undefined
            ? { backgroundColor: styles[props.status.replace("-","_") as keyof statusStyle] }
