...
function InvitationActions(props: props) {
  return (
    <div className="transaction-actions">
    <div className="action">
      <div onClick={props.handleValidateInvitation} className="action-icon">
        <FaCheck />
      </div>
      <div className="action-title">Validate Invitation</div>
    </div>
    <div className="action">
      <div onClick={props.handleRejectInvitation} className="action-icon">
        <HiOutlineLockClosed />
      </div>
