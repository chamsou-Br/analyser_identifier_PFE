...
class ActTypeSetting < ApplicationRecord
  ...
  def human_label
    ...
    I18n.translate(label, scope: "activerecord.attributes.act_type_setting.labels", default: label)
  end
