...
# == Schema Information
#
# Table name: act_eval_type_settings
#
...
class ActEvalTypeSetting < ApplicationRecord
  ...
  has_many :acts, foreign_key: :act_eval_type_id
  ...
  def human_label
    ...
    I18n.translate(label, scope: "activerecord.attributes.act_eval_type_setting.labels", default: label)
  end
